...
public class Constants {
    ...
    public static String ADD_ITEM       = "INSERT INTO Item (type, weight, value, status, description, nic) VALUES (?, ?, ?, ?, ?, ?)";
    public static String VIEW_ITEM      = "SELECT * FROM item WHERE item_id = ?";
    public static String UPDATE_ITEM    = "UPDATE item SET type = ?, weight = ?, value = ?, status = ?, description = ?, nic = ? WHERE item_id = ?";
    ...
    public static String ADD_LOAN       = "INSERT INTO loan (value, remainder, duedate, billdate, emp_nic, nic, item_id) VALUES (?, ?, ?, ?, ?, ?, ?)";
    public static String GET_ALL_LOANS  = "SELECT * FROM loan";
    public static String UPDATE_LOAN    = "UPDATE loan SET remainder = ?, nic = ? WHERE loan_id = ?";
    ...
    public static String UPDATE_PAYMENT = "UPDATE payment SET amount = ?, type = ? WHERE payment_id = ?";
    public static String DELETE_PAYMENT = "DELETE FROM payment WHERE paymentId = ?";
